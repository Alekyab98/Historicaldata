...
,
  ...
  distinct
    ...
    fqdn,
TO_JSON(JSON_REMOVE(SAFE.PARSE_JSON(labels),'$.__name__','$.jobid','$.job','$.localdn','$.write_relabel_group','$.instance','$.kubernetes_namespace','$.kubernetes_pod_name','$.applicationId')) as labels,
...
SELECT
  ...
  fqdn,
  trans_dt,
  SAFE.PARSE_JSON(TO_JSON_STRING(labels)) as labels,
--  instance,
  checksum,
  KEY,
  increase_value,
